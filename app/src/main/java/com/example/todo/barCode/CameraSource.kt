...
private constructor() {
    ...
    private val mDummySurfaceView: SurfaceView? = null
     ...
     */
    private val mBytesToByteBuffer: MutableMap<ByteArray, ByteBuffer> =
        HashMap()
    //==============================================================================================
    // Builder
    //==============================================================================================
     ...
     */
     inner class PictureStartCallback :
     ...
     */
     inner class PictureDoneCallback :
     ...
     */
    private inner class CameraAutoFocusCallback :
     ...
     */
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN)
    private inner class CameraAutoFocusMoveCallback :
        Camera.AutoFocusMoveCallback {
         var mDelegate: AutoFocusMoveCallback? = null
        override fun onAutoFocusMoving(
            start: Boolean,
            camera: Camera
        ) {
    ...
    private fun createCamera(): Camera {
        ...
        if (focusMode != null) {
            if (parameters.supportedFocusModes.contains(
                ...
                Log.i(
                    TAG,
                    "Camera focus mode: " + focusMode + " is not supported on this device."
                )
            }
        }
     ...
     */
    private class SizePair @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP) constructor(
    ...
    private fun selectPreviewFpsRange(
        ...
        val previewFpsRangeList =
            camera.parameters.supportedPreviewFpsRange
    ...
    private fun createPreviewBuffer(previewSize: Size?): ByteArray {
        ...
        val sizeInBits =
            previewSize!!.height * previewSize.width * bitsPerPixel.toLong()
