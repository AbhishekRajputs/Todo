...
public class BarcodeReaderFragment extends Fragment implements View.OnTouchListener, BarcodeGraphicTracker.BarcodeGraphicTrackerListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mFlashIcon = view.findViewById(R.id.img_flash);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mFlashToggle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!useFlash){
                    useFlash = true;
                   // mFlashToggle.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_flash_yellow, 0, 0, 0);
                    mFlashIcon.setBackgroundResource(R.drawable.ic_flash_yellow);
                }
                else{
                    useFlash = false;
                    mFlashIcon.setBackgroundResource(R.drawable.ic_flash);
                }
